...
public class TemplateHealthConditionViewController {
    @FXML
    ...
    public TemplateHealthConditionViewController() throws Exception {
    ...
    public void returnTemplate(ActionEvent actionEvent) {
        Stage thisStage = (Stage) ButtonLogOut.getScene().getWindow();
        thisStage.close();
    }
